...
class Add extends Component {
  ...
  render() {
    ...
    const rows = [
      { id: 1, code: '2020/FA/65d1/ID08/2000001031', receiver: 'Raka', department: 'Internal Audit', name: 'Notebook', quantity: '1', from_branch: '65D1 - HO Jakarta', from_room: 'Meeting Room', to_branch: '651A - Cikarang', to_room: 'Office Room', },
      { id: 2, code: '2020/FA/65d1/ID08/2000001032', receiver: 'Raka', department: 'Internal Audit', name: 'Notebook', quantity: '1', from_branch: '65D1 - HO Jakarta', from_room: 'Meeting Room', to_branch: '651A - Cikarang', to_room: 'Office Room', },
      { id: 3, code: '2020/FA/65d1/ID08/2000001033', receiver: 'Raka', department: 'Internal Audit', name: 'Notebook', quantity: '1', from_branch: '65D1 - HO Jakarta', from_room: 'Meeting Room', to_branch: '651A - Cikarang', to_room: 'Office Room', },
      { id: 4, code: '2020/FA/65d1/ID08/2000001034', receiver: 'Raka', department: 'Internal Audit', name: 'Notebook', quantity: '1', from_branch: '65D1 - HO Jakarta', from_room: 'Meeting Room', to_branch: '651A - Cikarang', to_room: 'Office Room', },
      { id: 5, code: '2020/FA/65d1/ID08/2000001035', receiver: 'Raka', department: 'Internal Audit', name: 'Notebook', quantity: '1', from_branch: '65D1 - HO Jakarta', from_room: 'Meeting Room', to_branch: '651A - Cikarang', to_room: 'Office Room', },
    ];
