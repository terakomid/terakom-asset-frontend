...
import { CloseRounded, Edit, FilterListRounded, MoreVert, Search } from "@mui/icons-material";
                              ...
                              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                 <TableHead>
                                    ...
                                    >
                                       ...
                                       {Permission(user.permission, "update stock opname") ? <TableCell align="center">Action</TableCell> : null}
                                    </TableRow>
                                 </TableHead>
                                 <TableBody>
                                    {rows !== undefined ? (
                                       rows.data.length > 0 ? (
                                          rows.data.map((value, key) => (
                                             <TableRow key={key}>
                                                ...
                                                {Permission(user.permission, "update stock opname") ? (
