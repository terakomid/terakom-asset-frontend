               ...
               <div className="d-flex">
                  ...
                  <div className="dropdown d-inline-block">
                     ...
                     <div className="dropdown-menu dropdown-menu-end">
                        ...
                        <a className="dropdown-item" style={{ display: "none" }} href="#link">
                           <i className="mdi mdi-wallet font-size-17 text-muted align-middle me-1"></i> My Wallet
                        </a>
                        <a className="dropdown-item d-block" style={{ display: "none" }} href="#link">
                           <span className="badge bg-success float-end">11</span>
                           <i className="mdi mdi-cog font-size-17 text-muted align-middle me-1"></i> Settings
                        </a>
                        <a className="dropdown-item" style={{ display: "none" }} href="#link">
                           <i className="mdi mdi-lock-open-outline font-size-17 text-muted align-middle me-1"></i>
                           Lock screen
                        </a>
                        <div className="dropdown-divider"></div>
                        <a className="dropdown-item text-danger" href="#link">
