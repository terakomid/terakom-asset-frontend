                                ...
                                <div className='card-body p-3'>
                                    <div className='row'>
                                        ...
                                        <div className='col-xl-8 col-12 mb-3'>
                                            <h2 className="fw-bold">Edit Data Asset Non IT</h2>
                                        </div>

                                        {/* Thumbnail */}
                                        <div className='col-md-6 offset-md-3 col-12 mb-5 text-center'>
                                            <img src="assets/images/asset-non-it.png" alt="" style={{ width: '100%', height: '190px' }} />
                                            <Button className='btn btn-primary fw-bold text-capitalize mt-5' variant='contained' >print label</Button>
                                        </div>
